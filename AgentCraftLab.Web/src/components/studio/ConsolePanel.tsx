...
export function ConsolePanel() {
  ...
  const ragCitations = useCoAgentStore((s) => s.state?.ragCitations as RagCitation[] | undefined)
  const expandedQueries = useCoAgentStore((s) => s.state?.expandedQueries as string[] | undefined)
