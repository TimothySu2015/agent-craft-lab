...
/// <summary>
/// EntityMemory 的 PostgreSQL 實作 — 儲存 Agent 執行中發現的實體及事實。
/// </summary>
public class PgEntityMemoryStore(IServiceScopeFactory scopeFactory) : IEntityMemoryStore
{
    ...
    public async Task<EntityMemoryDocument?> FindByNameAsync(string userId, string entityName)
    {
        ...
        // PostgreSQL 支援 ILIKE，但 EF Core LINQ 統一用 ToLower 比對
