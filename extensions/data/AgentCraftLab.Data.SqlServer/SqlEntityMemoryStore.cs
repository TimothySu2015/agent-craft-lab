...
/// <summary>
/// EntityMemory 的 SQL Server 實作 — 儲存 Agent 執行中發現的實體及事實。
/// </summary>
public class SqlEntityMemoryStore(IServiceScopeFactory scopeFactory) : IEntityMemoryStore
{
    ...
    public async Task<EntityMemoryDocument?> FindByNameAsync(string userId, string entityName)
    {
        ...
        // SQL Server 預設 CI 定序不區分大小寫，這裡用 ToLower 確保跨定序一致性
